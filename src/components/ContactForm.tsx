...
const schema = z.object({
  ...
  interest: z.string().min(1, "Please select an area"),
  ...
  return (
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Field label="Area of interest" error={errors.interest?.message}>
          <select
            className={fieldBase}
      ...
      <p className="mt-3 text-xs text-sand-700">
        By submitting, you agree to be contacted by Equal Research regarding your
        enquiry.
      </p>
    </form>
  );
