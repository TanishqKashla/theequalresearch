...
const variants: Record<Variant, string> = {
  ...
  outline:
    "border border-ink-900/55 bg-white/60 text-ink-900 hover:border-brand hover:text-brand hover:bg-white",
  ghost:
    "border border-ink-900/55 text-ink-900 hover:border-brand hover:text-brand",
};
